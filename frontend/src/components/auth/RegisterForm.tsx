  ...
  return (
    <div className="w-full max-w-md space-y-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
      <div className="text-center">
        <h2 className="text-3xl font-heading font-bold text-white tracking-wide">Create Account</h2>
        <p className="mt-2 text-sm text-blue-200/70">
          Or{' '}
          <Link href="/login" className="font-medium text-accent hover:text-white transition-colors">
